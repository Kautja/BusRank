...
const ContactPage = () => {
    ...
    const contactInfo = [
        ...
        },
        {
            icon: Mail,
            title: 'Email Us',
            details: [' busrankapp@gmail.com ', 'support@busrank.com'],
            color: 'from-red-500 to-rose-500',
            action: 'Send Email',
        },
        {
            icon: MapPin,
            title: 'Visit Us',
            details: ['Plot 23041. Phase 4 Gaborone Botswana'],
    ...
    const handleContactAction = (action, details) => {
        switch (action) {
            ...
            case 'Get Directions':
                window.open(
                    'https://www.google.com/maps/search/Plot+23041.+Phase+4+Gaborone+Botswana/@-24.6082062,25.8629749,12z/data=!3m1!4b1?entry=ttu&g_ep=EgoyMDI1MDgyNS4wIKXMDSoASAFQAw%3D%3D',
                );
                break;
                                ...
                                >
                                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-xl hover:shadow-2xl transition-all duration-300">
                                        ...
                                        <button
                                            ...
                                            className="text-red-500 font-medium text-sm hover:text-red-600 transition-colors mt-2"
                                        >
                                            {info.action} →
                                        </button>
                                    </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <Button
                                    ...
                                    size="lg"
                                    className="w-full bg-red-500 hover:bg-red-600 text-white px-8 py-3 text-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isSubmitting ? (
